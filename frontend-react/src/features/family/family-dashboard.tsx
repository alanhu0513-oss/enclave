        ...
        <StaggerItem>
          <Card>
            <CardContent className="flex items-center gap-4 pt-6">
              ...
              <div>
                <p className="text-2xl font-bold text-ink">{stats.activeMembers}</p>
        ...
        <StaggerItem>
          <Card>
            <CardContent className="flex items-center gap-4 pt-6">
              ...
              <div>
                <p className="text-2xl font-bold text-ink">{stats.totalAlerts}</p>
        ...
        <StaggerItem>
          <Card>
            <CardContent className="flex items-center gap-4 pt-6">
              ...
              <div>
                <p className="text-2xl font-bold text-ink">{stats.scansToday}</p>
              ...
              {members.map((m) => (
                <StaggerItem key={m.id}>
                  <div className="flex items-center gap-4 rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-green/15 text-green">
                    ...
                    <div className="flex items-center gap-6 text-sm text-ink-muted">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span>{m.alertCount || 0} alerts</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                        <Activity className="h-3.5 w-3.5 text-cyan" />
                        <span>{m.scanCount || 0} scans</span>
                      </div>
                      {m.lastActive && (
                        <div className="flex items-center gap-1.5">
