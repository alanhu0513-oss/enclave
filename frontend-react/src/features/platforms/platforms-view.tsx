...
const PLATFORMS: Platform[] = [
  ...
  { name: "DuckDuckGo", category: "Search Engines", icon: Search, coverage: "full", scanTypes: ["Web"], description: "Web result monitoring for mentions and image references." },

  // Social Media
  { name: "Reddit", category: "Social Media", icon: MessageSquare, coverage: "full", scanTypes: ["Image", "Video", "Text"], description: "Monitors posts, comments, and image uploads across r/deepfakes, r/DeepfakeDetection, r/SFWdeepfakes, and general search." },
  { name: "X (Twitter)", category: "Social Media", icon: MessageSquare, coverage: "full", scanTypes: ["Image", "Video", "Text"], description: "Tracks image and video posts, profile pictures, and mentions via DuckDuckGo site search." },
  { name: "Instagram", category: "Social Media", icon: Image, coverage: "full", scanTypes: ["Image", "Video"], description: "Monitors public posts and stories for unauthorized image use via search engine indexing." },
  { name: "TikTok", category: "Social Media", icon: Video, coverage: "full", scanTypes: ["Video", "Audio"], description: "Video content scanning and audio fingerprinting for voice clones via search indexing." },
  { name: "Facebook", category: "Social Media", icon: MessageSquare, coverage: "full", scanTypes: ["Image", "Video"], description: "Public post monitoring and image matching across Facebook via search engine indexing." },
  { name: "YouTube", category: "Social Media", icon: Video, coverage: "full", scanTypes: ["Video", "Audio"], description: "Video frame analysis and audio fingerprinting for deepfake detection via search indexing." },
  { name: "LinkedIn", category: "Social Media", icon: FileText, coverage: "full", scanTypes: ["Image", "Text"], description: "Profile picture monitoring and impersonation detection via search indexing." },
  { name: "Pinterest", category: "Social Media", icon: Image, coverage: "full", scanTypes: ["Image"], description: "Reverse image search for unauthorized pins and repins via search indexing." },
  { name: "Telegram", category: "Social Media", icon: MessageSquare, coverage: "full", scanTypes: ["Image", "Video", "Audio"], description: "Channel and group monitoring for shared deepfake content via t.me search." },
  ...
  { name: "Pastebox", category: "Paste Sites", icon: FileText, coverage: "full", scanTypes: ["Text"], description: "Searches pastebox.org for leaked identity data." },
  { name: "Hastebin", category: "Paste Sites", icon: FileText, coverage: "full", scanTypes: ["Text"], description: "Monitors hastebin.com for sensitive content." },
  { name: "Rentry", category: "Paste Sites", icon: FileText, coverage: "full", scanTypes: ["Text"], description: "Searches rentry.co paste site for identity mentions." },
  { name: "4chan", category: "Forums", icon: MessageSquare, coverage: "full", scanTypes: ["Image", "Video"], description: "Board monitoring across /b/, /v/, /pol/ and other boards for deepfake content." },
  ...
  { name: "Torum", category: "Dark Web", icon: Globe, coverage: "full", scanTypes: ["Text"], description: "Dark web social network monitoring for identity theft discussions." },
  { name: "Dread", category: "Dark Web", icon: Globe, coverage: "full", scanTypes: ["Text", "Image"], description: "Reddit-style dark web forum monitoring for deepfake trades." },
  { name: "Exploit.in", category: "Dark Web", icon: Globe, coverage: "full", scanTypes: ["Text"], description: "Russian dark web forum monitoring for stolen identity data." },
  { name: "Nulled.to", category: "Dark Web", icon: Globe, coverage: "full", scanTypes: ["Text", "Image"], description: "Dark web forum monitoring for leaked and stolen content." },
